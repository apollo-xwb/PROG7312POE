...
namespace MunicipalServicesApp.Pages
{
    public class ReportIssueModel : PageModel
    {
        ...
        public void OnGet()
        {
            RecentIssues = _issueManager.GetAllIssues().Take(5).ToList();
        }
        ...
        public IActionResult OnPost()
        {
            ...
            try
            {
                ...
                TempData["Success"] = $"Issue reported successfully! Issue ID: {addedIssue.Id}. Total issues now: {_issueManager.GetAllIssues().Count}";
                ...
                // Debug: Add issue count to success message
                TempData["Success"] += $" Recent issues count: {RecentIssues.Count}";
